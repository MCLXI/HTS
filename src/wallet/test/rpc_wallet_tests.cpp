...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CHTSAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CHTSAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CHTSAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CHTSAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CHTSAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CHTSAddress(arr[0].get_str()).Get() == demoAddress.Get());
