...
unlocked to sign the HTS-Qt.app bundle.
...
allowing somebody to distribute a HTS-Qt.app or HTS-qt-setup.exe with a valid
...
that the HTS-qt.exe file inside the installer had not been tampered with.
